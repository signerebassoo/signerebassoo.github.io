...
export default function HeroText() {
  return (
    <div className='text-center p-10'>
      <h2 className='sm:text-6xl text-5xl py-2 text-indigo-600 font-medium'>{'<Signe Rebassoo />'}</h2>
      <h3 className='sm:text-3xl text-2xl py-2'>Software developer and product engineer.</h3>
